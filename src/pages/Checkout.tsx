  ...
  return (
    <div className="mx-auto flex w-full max-w-[1002px] flex-col gap-[32px]">
      ...
      <div className="flex gap-[58px]">
          ...
          <div className="mb-[32px]">
            ...
            <div className="flex flex-col gap-[16px]">
              <div className="flex justify-between">
                <span className="text-md font-semibold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-700)' }}>Name</span>
                <span className="text-md font-bold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-950)' }}>{user?.name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-md font-semibold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-700)' }}>Email</span>
                <span className="text-md font-bold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-950)' }}>{user?.email}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-md font-semibold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-700)' }}>Nomor Handphone</span>
                <span className="text-md font-bold" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-950)' }}>{user?.phone || '-'}</span>
              </div>
            </div>
          </div>
        ...
        {/* Right: Borrow Form */}
        <div className="w-[478px] rounded-[12px] border border-solid border-[var(--color-neutral-200)] bg-white p-[20px]">
          ...
          <div className="mb-[24px]">
            ...
            <input
              ...
              className="w-full rounded-[12px] border border-solid border-[var(--color-neutral-300)] px-[16px] py-[12px] text-sm font-regular outline-none"
          ...
          <div className="mb-[24px]">
            ...
            <div className="flex flex-col gap-[12px]">
              {([3, 5, 10] as const).map((days) => (
                <label key={days} className="flex items-center gap-[12px] cursor-pointer">
                  <input
                    type="radio"
                    name="duration"
          ...
          <div className="mb-[24px] rounded-[8px] bg-[var(--color-neutral-50)] p-[16px]">
            ...
            <p className="text-sm font-regular" style={{ fontFamily: 'var(--font-family-quicksand)', color: 'var(--color-neutral-700)' }}>
              Please return the book no later than {returnDate.toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}
            </p>
          </div>
          ...
          <button
            ...
            disabled={checkoutMutation.isPending || !agreeReturn || !agreePolicy}
